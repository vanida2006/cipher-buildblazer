...
node scripts/make-admin.js admin "admin123456" SUPER_ADMIN
npm run dev
...
Deployed Main Website: https://cipher-endv.onrender.com/
Deployed Management Portal: https://cipher-admin-r8ws.onrender.com/
