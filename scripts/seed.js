...
function seed(database) {
  ...
  /* ---------- archive ---------- */
  const acts = [
    { title: 'Applied Machine Learning', category: 'WORKSHOP' },
    { title: 'Industrial Visit', category: 'INDUSTRIAL VISIT' },
    { title: 'LaTeX Tool', category: 'TECH TALK' },
    { title: 'Robotic Process Automation using UiPath', category: 'WORKSHOP' },
    { title: 'HackTO Future 20', category: 'COMPETITION' },
    { title: 'How to Win at the Sport of Programming', category: 'WORKSHOP' },
    { title: 'Introduction to Google Crowdsource', category: 'TECH TALK' },
    { title: 'Educational Session on GitHub', category: 'WORKSHOP' },
    { title: 'Generative AI Tools for Research', category: 'RESEARCH' },
    { title: 'UDAAN Mock Interview', category: 'CAREER PREP' },
    { title: 'Freshers Onboarding Programme', category: 'CAREER PREP' },
    { title: 'Projects Funded by KSCST', category: 'RESEARCH' },
    { title: 'React.js and Node.js Workshop', category: 'WORKSHOP' },
    { title: 'Introduction to Blockchain: Solidity Workshop', category: 'WORKSHOP' },
    { title: 'Star UML', category: 'TECH TALK' },
    { title: 'Generative AI: Custom Solutions using OpenAI', category: 'WORKSHOP' },
  ];
  const addA = db.prepare('INSERT INTO activities (title,category,sort_order) VALUES (?,?,?)');
  acts.forEach((a, i) => addA.run(a.title, a.category, i));
